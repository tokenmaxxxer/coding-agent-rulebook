...
# docs/issue-<n>/reports/coding.md, parse the PROPOSED content and
...
# shows work is left OPEN (a non-terminal state — not landed/
...
try:
    ...
    RECORDS_RE = re.compile(r'^docs/issue-[0-9]+/reports/coding\.md$')
